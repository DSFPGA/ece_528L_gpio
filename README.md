...
This subsection analyzes the behavior of the Launchpad, PMOD 8LD, and PMOD SWT modules with the initial of LED_Pattern_1 and LED_Pattern_2 provided for this lab. Figures 1-4 display the values of the buttons and LEDs for test cases 1-4 respectively of LED_Pattern_1. Figure 5 display the values of the buttons and switches for LED_Pattern_2. Figure 6 displays three test cases for LED_Pattern_2 which are the values of the LEDs at different points as it is not feasible to showcase all results. 
